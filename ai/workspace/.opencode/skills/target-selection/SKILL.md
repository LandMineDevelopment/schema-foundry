...
Creating a new local project is the exception to existing-target selection: call `schema_project_create` with the requested name without requiring a `schemaId` or `availableProjects` entry.
