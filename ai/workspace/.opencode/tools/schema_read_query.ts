...
export default tool({
  description: "Propose a read-only PostgreSQL query for an exact Schema Foundry profile and namespace. Raw SQL always requires UI approval.",
  args: {
  ...
  async execute(args) {
    return "SCHEMA_FOUNDRY_ACTION:" + JSON.stringify({
